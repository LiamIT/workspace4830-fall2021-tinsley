...
public class UtilPropTinsley {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\Liam's PC\\Desktop\\Intro to Software\\workspace4830\\workspace4830-TechEx-Tinsley\\webproject-techex-tinsley\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/Users/liamtinsley/Desktop/Software Engineering/Workspace/Workspace4830-TechEx-Tinsley/webproject-techex-tinsley/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/webproject-techex-tinsley/config.properties";
